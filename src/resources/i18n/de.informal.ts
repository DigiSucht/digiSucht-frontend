export const deInformal = {
	...
	booking: {
		availability: {
			description:
				'Gib hier Deine allgemeine Verfügbarkeit an, damit Ratsuchende Termine bei Dir buchen können.',
			title: 'Deine Verfügbarkeit'
		},
		calender: {
			synchroniseCalender: {
				description:
					'Synchronisiere Deinen Kalender, den Du in Deiner Beratungsstelle nutzt, mit der Online Beratung. Deine Verfügbarkeit wird dann automatisch angepasst und Terminkonflikte verhindert.'
			}
		},
		event: {
			description: 'Deine Nachricht zum Termin',
			your: {
				counselor: 'Dein Berater'
			},
			tooltip: {
				consultant:
					'Falls Du den Termin nicht in dem vom Ratsuchenden gewählten Modus wahrnehmen kannst, generieren wir für Dich immer einen Link zum Video-Call als Alternative.',
				adviceSeeker:
					'Falls Dein:e Berater:in den Termin nicht in dem von Dir gewählten Modus wahrnehmen kann, generieren wir für Dich immer einen Link zum Video-Call als Alternative.'
			}
		},
		my: {
			booking: {
				schedule: 'Vereinbare jetzt einen Termin mit'
			}
		}
	},
	termsAndConditionOverlay: {
		contentLine1: {
			...
			privacy:
				'Wir haben die Datenschutzerklärung der Online-Beratung aktualisiert. Den aktuellen Stand findest Du hier.',
	...
	error: {
		statusCodes: {
			400: {
				description: 'Die von Dir eingegebene URL ist ungültig.'
			},
			401: {
				description:
					'Leider bist Du nicht berechtigt diese Seite einzusehen.'
			},
			500: {
				description:
					'Wie es aussieht, haben wir momentan ein Serverproblem.<br>Versuche es später noch einmal.'
			}
		}
	},
	furtherSteps: {
	...
	groupChat: {
		...
		leaveChat: {
			securityOverlay: {
				headline: 'Möchtest Du den Chat wirklich verlassen?'
			}
		},
		listItem: {
			subjectEmpty: {
	...
	help: {
		videoCall: {
			...
			banner: {
				content:
					'Bitte verwende einen anderen Browser, um Video-Calls zu ermöglichen.'
			},
			asker: {
	...
	message: {
		...
		appointmentRescheduled: {
			title: 'Dein Termin wurde verschoben'
		},
		appointmentSet: {
			title: 'Dein Termin wurde erstellt'
		},
		submit: {
			booking: {
				headline: 'Oder vereinbaren Sie jetzt einen Termin'
			}
		},
		delete: {
			deleted: {
		...
		video: {
			description: 'Du kannst jetzt an der Videokonferenz teilnehmen'
		}
	},
	notifications: {
		message: {
			new: 'Du hast eine neue Nachricht!'
		},
		enquiry: {
			new: 'Du hast eine neue Live-Chat Anfrage!'
		},
		initialRequest: {
			new: 'Du hast eine neue Erstanfrage!'
		}
	},
	overlay: {
		timeout: {
	...
	profile: {
		...
		notifications: {
			...
			'error': {
				description:
					'Leider können wir Deine Einstellungen momentan nicht aktualisieren. Bitte versuche es später noch einmal.'
			},
			'toggleError': {
				description:
			...
			'noEmail': {
				...
				modal: {
					...
					errorMessage:
						'Leider können wir Deine E-Mail-Adresse momentan nicht speichern. Bitte versuche es später noch einmal oder kontaktiere unseren Support.'
				}
			}
		},
		...
		documentation: {
			description:
				'Hast Du Fragen? Im Handbuch findest Du detaillierte Informationen zu den wichtigsten Funktionen der Online-Beratungsplattform.'
		},
		spokenLanguages: {
		...
		unsetEmail: {
			confirmOverlay: {
				benefit: {
					1: 'erhältst Du keine E-Mail-Benachrichtigung, wenn Dein_e Berater_in Dir geschrieben hat',
					2: 'kannst Du Dein Passwort nicht zurücksetzen, falls Du es vergessen hast.'
				},
				copy: 'Wenn Du Deine E-Mail-Adresse löschst:',
				headline: 'Möchtest Du Deine E-Mail-Adresse wirklich löschen?'
			},
			errorOverlay: {
				headline:
					'Ups! Wir konnten die E-Mail-Adresse gerade nicht löschen. Bitte versuche es noch einmal.'
			},
			successOverlay: {
	...
	sessionList: {
		...
		unavailable: {
			description:
				'Aktiviere Deine Verfügbarkeit und erhalte hier die Live-Chat Anfragen von anonymen Ratsuchenden'
		}
	},
	statusOverlay: {
		error: {
			text: 'Es ist ein Problem aufgetreten, bitte versuche es erneut'
		},
		success: {
	...
	tools: {
		calendar: {
			description:
				'Trage Deine Urlaube oder sonstigen Termine in den Kalender ein, sodass die Ratsuchenden in dieser Zeit keine Termine bei Dir buchen können.<br/>Melde Dich mit der gleichen E-Mail-Adresse und Passwort an, das Du auch hier bei der Online Beratung verwendest.'
		}
	},
	twoFactorAuth: {
		subtitle:
	...
	userProfile: {
		...
		tools: {
			description: 'Schalte Tools für die_den Ratsuchende_n frei. ',
			options: {
				saveError:
					'Beim Werkzeugwechsel ist ein Problem aufgetreten. Bitte versuche es erneut.'
			},
			share: {
				title: 'Sieh hier, welche Inhalte mit Dir geteilt wurden.',
	...
	videoCall: {
		...
		statusPage: {
			closed: {
				title: 'Dein Video-Call wurde erfolgreich beendet.',
				action: 'Bitte schließe diesen Tab, um zu Beratung & Hilfe zurückzukehren.'
			},
			unauthorized: {
				reason: 'Leider bist Du nicht berechtigt diese Seite einzusehen.',
				action: 'Bitte schließe diesen Tab, um zu Beratung & Hilfe zurückzukehren.'
			}
		}
	},
	...
	walkthrough: {
		subtitle:
			'Um Dir die einzelnen Funktionen zu erklären, haben wir einen kurzen Rundgang für Dich vorbereitet. <br /> Du kannst ihn jederzeit abbrechen oder in Deinem Profil erneut starten.',
		step: {
			'0': {
